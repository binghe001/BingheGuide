...
export default defineUserConfig({
  ...
  extendsMarkdown(md) {
    ...
    const knownHtmlTags = new Set([
      ...
      'figcaption','figure','footer','form','font','h1','h2','h3','h4','h5','h6',
      ...
      'u','ul','var','video','wbr','center','strike','tt','big','acronym','dir',
      'frame','frameset','keygen','listing','marquee','menuitem','multicol','nobr',
      'noembed','noframes','param','plaintext','rb','rtc','spacer','xmp'
    ])
    md.renderer.rules.html_inline = (tokens: any[], idx: number) => {
      const content = tokens[idx].content
      const tagMatch = content.match(/^<\/?([a-zA-Z][a-zA-Z0-9-]*)/)
      if (tagMatch) {
        const tagName = tagMatch[1].toLowerCase()
        if (knownHtmlTags.has(tagName)) return content
      }
    ...
    return [
        ...
        },
        {
            ...
            children: [
                ...
                "coding/2026-04-14-chapter03.md",
