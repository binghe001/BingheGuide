        ...
        <div class="toc-container">
            <div class="pos-box">
              ...
              <div class="scroll-box" style="text-align:center" >
                ...
                <img v-bind="{src: 'https://api.qrserver.com/v1/create-qr-code/?data=https://binghe.site'+this.$route.fullPath }" height="180px" style="margin:10px;"/>
        ...
        <div class="toc-container">
            <div class="pos-box">
              ...
              <div class="scroll-box" style="text-align:center" >
                ...
                <img src="/images/personal/hacker_binghe.jpg" height="180px" style="margin:10px;"/>
