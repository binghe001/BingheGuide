---
title: 第72章：基于Spring XML接入服务消费者
pay: https://articles.zsxq.com/id_ewc703dwui4u.html
---
...
在整合Spring篇章，我们已经实现了服务提供者整合Spring，并基于Spring XML和注解的方式实现了如何接入服务提供者。同时，也实现了服务消费者整合Spring。

## 一、前言

`服务消费者整合了Spring，我可以基于Spring的XML接入服务消费者吗？`
...
在整合Spring的篇章中，实现了服务提供者整合Spring，并实现了基于Spring XML和注解的方式接入服务提供者。也实现了服务消费者整合Spring。

## 二、目标

`目标很明确：基于Spring XML接入服务消费者!`

在整合Spring的篇章中，我们一起实现了服务提供者整合Spring，并实现了基于Spring XML和Spring注解的方式接入服务提供者。也实现了服务消费者整合Spring的功能，但是服务消费者整合Spring功能只是实现了功能，那如何基于Spring接入RPC呢？本章，我们就要实现基于Spring XML的方式接入服务消费者。

## 三、设计

`如果让你设计基于Spring XML接入服务消费者的流程，你会怎么设计呢？`
...
（13）服务消费者支持以Java原生程序方式和整合Spring的方式提供服务。并且实现了基于Spring XML的方式接入RPC框架的服务消费者。
