...
![rpc-2022-06-30-002](https://binghe.site/assets/images/middleware/rpc/rpc-2022-06-30-002.png)

* 异步调用

![rpc-2022-06-30-003](https://binghe.site/assets/images/middleware/rpc/rpc-2022-06-30-003.png)

* 回调

![rpc-2022-06-30-004](https://binghe.site/assets/images/middleware/rpc/rpc-2022-06-30-004.png)

* 单向调用

![rpc-2022-06-30-005](https://binghe.site/assets/images/middleware/rpc/rpc-2022-06-30-005.png)
...
![rpc-2022-08-24-003](https://binghe.site/assets/images/middleware/rpc/rpc-2022-08-24-003.png)

![rpc-2022-08-24-006](https://binghe.site/assets/images/middleware/rpc/rpc-2022-08-24-006.png)

**项目大量使用了对标Dubbo的自定义SPI技术实现高度可扩展性，各位小伙伴可以根据自己的需要，按照SPI的设计要求添加自己实现的自定义插件。**

![rpc-2022-08-24-001](https://binghe.site/assets/images/middleware/rpc/rpc-2022-08-24-001.jpg)
...
![rpc-2022-06-25-002](https://binghe.site/assets/images/middleware/rpc/rpc-2022-06-25-002.png)
