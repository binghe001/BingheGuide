...
《RPC手撸专栏》到目前为止，源码已经有60+个子工程，完成了：自定义注解、自定义包扫描类、自定义协议、请求与响应协议的封装、服务提供者、服务消费者、注册中心、负载均衡与增强型负载均衡、序列化与反序列化、动态代理、反射机制、心跳机制、重试机制、整合Spring和整合SpringBoot，给大家留个整合SpringBoot阶段的作业。
...
* SpringBoot的类加载机制是什么？
* SpringBoot有哪些功能上的扩展点？
* SpringBoot与Spring的区别是什么？
* 你是如何理解SpringBoot这种技术的？给你带来了哪些启示？
* RPC框架整合SpringBoot使用到了哪些扩展点？
* 你从RPC框架整合SpringBoot的实现中学到了什么？
