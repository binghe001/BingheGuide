...
title: 第05章：Mycat中文乱码解决方案
tagline: by 冰河
tag: [mycat,mycat-core-base,mycat-core]
excerpt: 第05章：Mycat中文乱码解决方案
lock: need
---
...
* 本章难度：★★☆☆☆
* 本章重点：介绍Mycat中文乱码的解决方案，理解产生乱码的根本原因，并能够在实际项目中避免Mycat中文乱码的问题。

**大家好，我是冰河~~**

今天给大家介绍《Mycat核心技术》的第05章：给大家简单介绍下Mycat中文乱码的解决方案，好了，开始今天的内容。
...
**注：[mysqld]处也可使用default-character-set=utf8，如果启动mysql服务出错的话，就使用character_set_server=utf8mb4。**
...
如果业务需要utf8mb4 等复杂字符集配置对应修改：

默认的是utf8格式的，明确指定在server.xml下的system标签下添加格式如下：

```xml
<propertyname="charset">utf8mb4</property>
```

然后根据数据库端的字符集ID配置mycat的字符集
