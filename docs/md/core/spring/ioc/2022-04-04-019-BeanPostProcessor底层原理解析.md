...
![005](/assets/images/core/spring/ioc/2022-04-04-019-005.png)
...
![006](/assets/images/core/spring/ioc/2022-04-04-019-006.png)

在AnnotationConfigApplicationContext类的构造方法中会调用refresh()方法。我们跟进方法调用栈，如下所示。

![007](/assets/images/core/spring/ioc/2022-04-04-019-007.png)
...
![008](/assets/images/core/spring/ioc/2022-04-04-019-008.png)
...
![009](/assets/images/core/spring/ioc/2022-04-04-019-009.png)

可以看到，方法的执行定位到DefaultListableBeanFactory的preInstantiateSingletons()方法的最后一个else分支调用的getBean()方法上。继续跟进方法调用栈，如下所示。

![010](/assets/images/core/spring/ioc/2022-04-04-019-010.png)
...
![011](/assets/images/core/spring/ioc/2022-04-04-019-011.png)

可以看到，在Spring内部是通过getSingleton()来获取单实例bean的，我们继续跟进方法调用栈，如下所示。

![012](/assets/images/core/spring/ioc/2022-04-04-019-012.png)
...
![013](/assets/images/core/spring/ioc/2022-04-04-019-013.png)
...
![014](/assets/images/core/spring/ioc/2022-04-04-019-014.png)
...
![015](/assets/images/core/spring/ioc/2022-04-04-019-015.png)
...
![016](/assets/images/core/spring/ioc/2022-04-04-019-016.png)
