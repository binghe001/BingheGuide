...
![001](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-001.png)

随后，我们以Debug的方式来运行BeanLifeCircleTest类的testBeanLifeCircle04()方法，运行后的效果如下所示。

![002](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-002.png)

可以看到，程序已经运行到MyBeanPostProcessor类的postProcessBeforeInitialization()方法中，在IDEA的左下角我们可以清晰的看到方法的调用栈，如下所示。

![003](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-003.png)
...
![005](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-005.png)
...
![006](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-006.png)

在AnnotationConfigApplicationContext类的构造方法中会调用refresh()方法。我们跟进方法调用栈，如下所示。

![007](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-007.png)
...
![008](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-008.png)
...
![009](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-009.png)

可以看到，方法的执行定位到DefaultListableBeanFactory的preInstantiateSingletons()方法的最后一个else分支调用的getBean()方法上。继续跟进方法调用栈，如下所示。

![010](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-010.png)
...
![011](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-011.png)

可以看到，在Spring内部是通过getSingleton()来获取单实例bean的，我们继续跟进方法调用栈，如下所示。

![012](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-012.png)
...
![013](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-013.png)
...
![014](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-014.png)
...
![015](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-015.png)
...
![016](https://binghe.site/assets/images/core/spring/ioc/2022-04-04-019-016.png)
